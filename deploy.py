...
# {'sentence': '아침으로 간단하게 먹을 음식추천해줘. 오이, 시금치, 생선은 빼고.',
#  'result': [{'token': '아침', 'predicted_tag': '식단구조', 'top_prob': '0.6189'},
#   {'token': '##으로', 'predicted_tag': 'O', 'top_prob': '0.9868'},
#   {'token': '간단', 'predicted_tag': '식단한종류', 'top_prob': '0.8242'},
#   {'token': '##하게', 'predicted_tag': 'O', 'top_prob': '0.9681'},
#   {'token': '먹을', 'predicted_tag': 'O', 'top_prob': '0.9153'},
#   {'token': '음식', 'predicted_tag': 'O', 'top_prob': '0.9943'},
#   {'token': '##추', 'predicted_tag': 'O', 'top_prob': '0.9732'},
#   {'token': '##천', 'predicted_tag': 'O', 'top_prob': '0.9726'},
#   {'token': '##해줘', 'predicted_tag': 'O', 'top_prob': '0.9661'},
#   {'token': '.', 'predicted_tag': 'O', 'top_prob': '0.9808'},
#   {'token': '오', 'predicted_tag': '식재료', 'top_prob': '0.9818'},
#   {'token': '##이', 'predicted_tag': '식재료', 'top_prob': '0.99'},
#   {'token': ',', 'predicted_tag': 'O', 'top_prob': '0.9873'},
#   {'token': '시', 'predicted_tag': '식재료', 'top_prob': '0.9597'},
#   {'token': '##금', 'predicted_tag': '식재료', 'top_prob': '0.9704'},
#   {'token': '##치', 'predicted_tag': '식재료', 'top_prob': '0.9862'},
#   {'token': ',', 'predicted_tag': 'O', 'top_prob': '0.9872'},
#   {'token': '생선', 'predicted_tag': '식재료', 'top_prob': '0.9689'},
#   {'token': '##은', 'predicted_tag': 'O', 'top_prob': '0.9633'},
#   {'token': '빼고', 'predicted_tag': '비선호표현', 'top_prob': '0.9147'},
#   {'token': '.', 'predicted_tag': 'O', 'top_prob': '0.9578'}]}
